...
export declare class StreamlinedOrchestrator {
    private sessions;
    private contexts;
    private messages;
    private events;
...
export declare function createStreamlinedOrchestrator(): StreamlinedOrchestrator;
export declare const orchestrator: StreamlinedOrchestrator;
