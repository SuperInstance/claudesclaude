...
export declare class MicroOrchestrator {
    private sessions;
    private contexts;
    private messages;
    private events;
...
export declare function createMicroOrchestrator(): MicroOrchestrator;
export declare const microOrchestrator: MicroOrchestrator;
