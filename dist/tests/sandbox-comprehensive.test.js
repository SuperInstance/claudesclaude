    ...
    describe('End-to-End Integration Testing', () => {
        ...
        it('should handle multiple concurrent sandboxes with isolation', async () => {
            ...
            for (const id of sandboxIds) {
                promises.push(sandboxManager.createSandbox({
                    id,
                    name: `concurrent-${id}`,
            ...
            const taskPromises = createdIds.map(id => sandboxManager.executeInSandbox(`task-${id}`, ['node', '-e', 'console.log("Task completed");']));
...
//# sourceMappingURL=sandbox-comprehensive.test.js.map